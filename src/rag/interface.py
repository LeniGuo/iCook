...
BCERerank(BaseDocumentCompressor):
https://github.com/netease-youdao/BCEmbedding/blob/master/BCEmbedding/tools/langchain/bce_rerank.py

HyDE:
https://github.com/langchain-ai/langchain/tree/master/libs/langchain/langchain/chains/hyde
"""
# TODO: Refactor
def load_retriever():
    ...
    compression_retriever = HyQEContextualCompressionRetriever(base_compressor=reranker,
                                                               base_retriever=ensemble_retriever)  # TODO: 改用Langchain集成的HyDE
    return compression_retriever


"""源代码参考
PromptTemplate(StringPromptTemplate):
https://github.com/langchain-ai/langchain/blob/master/libs/core/langchain_core/prompts/prompt.py#L19

RetrievalQA(BaseRetrievalQA):
https://github.com/langchain-ai/langchain/blob/master/libs/langchain/langchain/chains/retrieval_qa/base.py#L199

LLMChain(Chain):
https://github.com/langchain-ai/langchain/blob/master/libs/langchain/langchain/chains/llm.py#L43

ConversationalRetrievalChain(BaseConversationalRetrievalChain):
https://github.com/langchain-ai/langchain/blob/master/libs/langchain/langchain/chains/conversational_retrieval/base.py#L245
"""
# TODO: Refactor
